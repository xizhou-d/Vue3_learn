...
// import App from './08_Provide和Inject/App'
// import App from './09_事件总线的使用/App'
// import App from './10_生命周期函数演练/App'
// import App from './11_ref获取元素或组件/App'
// import App from './12_动态组件的使用/App'
// import App from './13_Keep-Alive的使用/App'
// import App from './14_异步组件的使用/App'
// import App from './15_组件的v-model/App'
import App from './16_组件的混入-mixin/App'
